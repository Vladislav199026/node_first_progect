...
var fetchData = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get(url).then(function (response) { return response.data; })];
...
var fetchSequentially = function (urls) { return __awaiter(void 0, void 0, void 0, function () {
    var results, _i, urls_1, url;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                results = [];
            ...
            case 1:
                ...
                url = urls_1[_i];
                return [4 /*yield*/, fetchData(url).then(function (response) { return results.push(response); })];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
...
authenticateUser('admin', 'admin1231')
    .then(function (user) {
